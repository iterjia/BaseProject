...
public class ExcelUtil {
     ...
     * @return
     */
    public static Map<String, Object> makeSheet(String sheetName, Class<?> pojoClass, List<?> data) {
        ExportParams exportParams = new ExportParams();
        exportParams.setSheetName(sheetName);
        exportParams.setType(ExcelType.XSSF);
        Map<String, Object> sheetInfoMap = new HashMap<>();
        sheetInfoMap.put("title", exportParams);
        sheetInfoMap.put("entity", pojoClass);
        sheetInfoMap.put("data", data);
        return sheetInfoMap;
    }
