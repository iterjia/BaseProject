...
public class RequestLogAspect {
     ...
     */
    @Around(
            "execution(!static com.hy.common.tool.R *(..)) && " +
    ...
    public Object aroundApi(ProceedingJoinPoint point) throws Throwable {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            if (requestBody != null && value != null) {
                paraMap.putAll(Utils.toMap(value));
                continue;
            }
            // 处理 List
            ...
            if (value instanceof HttpServletRequest) {
                ...
                String paraName;
                if (requestParam != null && Utils.isNotBlank(requestParam.value())) {
        ...
        if (paraMap.isEmpty()) {
            ...
            beforeReqArgs.add(Utils.toJson(paraMap));
        }
        // 打印请求头
        ...
        try {
            ...
            afterReqArgs.add(Utils.toJson(result));
            return result;
        } finally {
